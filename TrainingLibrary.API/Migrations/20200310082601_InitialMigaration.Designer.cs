...
namespace TrainingLibrary.API.Migrations
{
    ...
    [Migration("20200310082601_InitialMigaration")]
            ...
            modelBuilder.Entity("CourseLibrary.API.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1991, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            FirstName = "Matija",
                            LastName = "Katadzic",
                            MainCategory = "Ships"
                        },
